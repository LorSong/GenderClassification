...
def process_image(image_path, img_size=(96,96)):
    """
     Takes image path and returns resized tensored image
    """
...
def make_predictions(model, image_paths, filenames):
    """
    Takes trained model and paths to images with their names.
...
def find_and_process_images(path_to_images):     
    ...
    if image_paths:   
        ...
        print("Error: no .jpg or .jpeg files were found. Check path")
